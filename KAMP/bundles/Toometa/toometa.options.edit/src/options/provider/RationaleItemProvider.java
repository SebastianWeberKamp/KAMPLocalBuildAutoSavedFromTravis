...
/**
 * This is the item provider adapter for a {@link options.Rationale} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RationaleItemProvider extends IdentifierItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Rationale_rationaleText_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Rationale_rationaleText_feature", "_UI_Rationale_type"),
				 OptionsPackage.Literals.RATIONALE__RATIONALE_TEXT,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Rationale)object).getRationaleText();
