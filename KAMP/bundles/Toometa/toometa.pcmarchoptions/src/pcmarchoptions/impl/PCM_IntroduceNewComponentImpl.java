...
import archoptions.impl.IntroduceNewComponentImpl;
 ...
 * </p>
 * <ul>
 *   <li>{@link pcmarchoptions.impl.PCM_IntroduceNewComponentImpl#getAssemblyContexts <em>Assembly Contexts</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PCM_IntroduceNewComponentImpl extends IntroduceNewComponentImpl implements PCM_IntroduceNewComponent {
	...
	public EList<AssemblyContext> getAssemblyContexts() {
		return (EList<AssemblyContext>)eDynamicGet(PcmarchoptionsPackage.PCM_INTRODUCE_NEW_COMPONENT__ASSEMBLY_CONTEXTS, PcmarchoptionsPackage.Literals.PCM_INTRODUCE_NEW_COMPONENT__ASSEMBLY_CONTEXTS, true, true);
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PcmarchoptionsPackage.PCM_INTRODUCE_NEW_COMPONENT__ASSEMBLY_CONTEXTS:
