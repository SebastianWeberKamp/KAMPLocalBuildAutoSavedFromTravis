...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>relations</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class RelationsExample {
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.relations"));
				RelationType root = RelationsFactory.eINSTANCE.createRelationType();
