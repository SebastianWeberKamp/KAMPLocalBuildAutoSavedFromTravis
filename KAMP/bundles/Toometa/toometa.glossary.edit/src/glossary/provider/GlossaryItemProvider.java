...
/**
 * This is the item provider adapter for a {@link glossary.Glossary} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GlossaryItemProvider extends IdentifierItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Glossary_title_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Glossary_title_feature", "_UI_Glossary_type"),
				 GlossaryPackage.Literals.GLOSSARY__TITLE,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GlossaryPackage.Literals.GLOSSARY__TERMS);
		}
	...
	public String getText(Object object) {
		String label = ((Glossary)object).getTitle();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GlossaryPackage.Literals.GLOSSARY__TERMS,
