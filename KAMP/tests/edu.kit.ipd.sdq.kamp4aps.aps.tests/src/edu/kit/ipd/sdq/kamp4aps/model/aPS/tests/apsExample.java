...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>aPS</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class apsExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.aps"));
				Plant root = apsFactory.eINSTANCE.createPlant();
