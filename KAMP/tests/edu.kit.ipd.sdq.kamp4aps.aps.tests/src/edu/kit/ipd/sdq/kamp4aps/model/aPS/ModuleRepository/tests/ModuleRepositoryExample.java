...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>ModuleRepository</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class ModuleRepositoryExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(ModuleRepositoryPackage.eNS_URI, 
			 ModuleRepositoryPackage.eINSTANCE);
