...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>InterfaceRepository</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class InterfaceRepositoryExample {
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(InterfaceRepositoryPackage.eNS_URI, 
			 InterfaceRepositoryPackage.eINSTANCE);
