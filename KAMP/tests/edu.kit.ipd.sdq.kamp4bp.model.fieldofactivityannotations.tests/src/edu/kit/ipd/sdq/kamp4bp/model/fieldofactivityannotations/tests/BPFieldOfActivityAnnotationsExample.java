...
import edu.kit.ipd.sdq.kamp4bp.model.fieldofactivityannotations.util.BPFieldOfActivityAnnotationsResourceFactoryImpl;
...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>fieldofactivityannotations</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class BPFieldOfActivityAnnotationsExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		resourceSet.getResourceFactoryRegistry().getExtensionToFactoryMap().put
			(Resource.Factory.Registry.DEFAULT_EXTENSION, 
			 new BPFieldOfActivityAnnotationsResourceFactoryImpl());

		// Register the package to ensure it is available during loading.
		//
		resourceSet.getPackageRegistry().put
			(BPFieldOfActivityAnnotationsPackage.eNS_URI, 
		...
		if (args.length == 0) {
			...
			try {
				...
				BPFieldOfActivityAnnotationsRepository root = BPFieldOfActivityAnnotationsFactory.eINSTANCE.createBPFieldOfActivityAnnotationsRepository();
...
} //BPFieldOfActivityAnnotationsExample
