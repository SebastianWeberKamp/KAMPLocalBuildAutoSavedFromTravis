 ...
 * @generated
 */
public class ISFieldOfActivityAnnotationsExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(ISFieldOfActivityAnnotationsPackage.eNS_URI, 
			 ISFieldOfActivityAnnotationsPackage.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				...
				ISFieldOfActivityAnnotationsRepository root = ISFieldOfActivityAnnotationsFactory.eINSTANCE.createISFieldOfActivityAnnotationsRepository();
...
} //ISFieldOfActivityAnnotationsExample
