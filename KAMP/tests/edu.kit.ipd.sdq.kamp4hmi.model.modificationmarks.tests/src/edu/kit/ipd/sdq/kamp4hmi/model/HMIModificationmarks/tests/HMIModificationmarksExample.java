...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>HMIModificationmarks</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class HMIModificationmarksExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(HMIModificationmarksPackage.eNS_URI, 
			 HMIModificationmarksPackage.eINSTANCE);
