...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>IECRepository</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class IECRepositoryExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(IECRepositoryPackage.eNS_URI, 
			 IECRepositoryPackage.eINSTANCE);
