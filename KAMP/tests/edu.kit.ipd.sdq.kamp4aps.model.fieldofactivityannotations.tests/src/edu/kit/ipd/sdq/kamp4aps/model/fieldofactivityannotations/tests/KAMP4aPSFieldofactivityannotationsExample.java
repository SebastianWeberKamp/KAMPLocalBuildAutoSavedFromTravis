 ...
 * @generated
 */
public class KAMP4aPSFieldofactivityannotationsExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(KAMP4aPSFieldofactivityannotationsPackage.eNS_URI, 
			 KAMP4aPSFieldofactivityannotationsPackage.eINSTANCE);
...
} //KAMP4aPSFieldofactivityannotationsExample
