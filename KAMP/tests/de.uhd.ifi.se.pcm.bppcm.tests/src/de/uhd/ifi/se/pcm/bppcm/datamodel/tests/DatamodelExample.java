...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>datamodel</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class DatamodelExample {
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.datamodel"));
				CollectionDataObject root = DatamodelFactory.eINSTANCE.createCollectionDataObject();
